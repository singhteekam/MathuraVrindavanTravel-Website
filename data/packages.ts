...
export const ALL_PACKAGES: PackageData[] = [
  {
    ...
    shortDescription:
      'Complete Mathura and Vrindavan darshan in a single day — ideal for pilgrims on a tight schedule.',
    pricing: [
  ...
  },
  {
    ...
    shortDescription:
      'Two days to soak in the spiritual energy of Mathura and Vrindavan with a comfortable overnight stay.',
    pricing: [
  ...
  },
  {
    ...
    shortDescription:
      'Extended pilgrimage covering Mathura, Vrindavan, Govardhan and Barsana over three blessed days.',
  },
  {
    ...
    shortDescription:
      'Combine a divine pilgrimage with the wonder of the Taj Mahal in this perfect 3-day itinerary.',
  },
  {
    ...
    shortDescription:
      'The most comprehensive 4-day Braj pilgrimage covering Mathura, Vrindavan, Gokul, Govardhan and more.',
  },
  {
    ...
    shortDescription:
      'A unique combination of spiritual pilgrimage and nature exploration at Bharatpur bird sanctuary.',
  },
  {
    ...
    shortDescription:
      'The ultimate Braj pilgrimage — a sacred 84 Kos Parikrama covering every divine site of Lord Krishna.',
  },
  {
    ...
    shortDescription:
      'Eight days of complete immersion in the Braj Mandal — the most comprehensive Krishna pilgrimage available.',
  },
]

// Detailed itinerary data keyed by slug
